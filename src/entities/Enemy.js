...
export class Enemy {
  ...
  setupStats() {
    const stats = {
      skeleton: { maxHealth: 30, health: 30, damage: 10, speed: 50, attackRange: 40, detectionRange: 200, soulValue: 1, goldValue: 5 },
      zombie: { maxHealth: 50, health: 50, damage: 15, speed: 30, attackRange: 35, detectionRange: 150, soulValue: 2, goldValue: 8 },
      demon: { maxHealth: 80, health: 80, damage: 20, speed: 70, attackRange: 60, detectionRange: 250, soulValue: 5, goldValue: 20 },
      ghost: { maxHealth: 40, health: 40, damage: 12, speed: 90, attackRange: 50, detectionRange: 300, soulValue: 3, goldValue: 12 },
      spider: { maxHealth: 25, health: 25, damage: 8, speed: 80, attackRange: 30, detectionRange: 180, soulValue: 1, goldValue: 3 }
    };
  ...
  attack() {
    ...
    if (distance < this.attackRange) {
      this.events.emit('enemy:attack', { enemy: this, target: this.target, damage: this.damage });
    }
  }
  ...
  die() {
    ...
    if (this.target && this.target.addSouls) this.target.addSouls(this.soulValue);
    if (this.target && this.target.addGold) this.target.addGold(this.goldValue);
  }
